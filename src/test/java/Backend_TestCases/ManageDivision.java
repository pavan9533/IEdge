...
public class ManageDivision extends BaseClass{
	...
	public void validateManageDivision() {
		...
		application.validateElementPresent("manageDivisionAddDivisionButton_xath", "Manage Division add division Button");
		application.validateElementPresent("manageDivisonTable_xpath" , "Manage Division Table");
		application.wait(2);
		application.click("manageDivisionAddDivisionButton_xath", "Manage Division add division Button");
		application.wait(2);
